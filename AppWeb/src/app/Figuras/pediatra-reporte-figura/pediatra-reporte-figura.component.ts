...
@Component({
  selector: 'app-pediatra-reporte-figura',
  templateUrl: './pediatra-reporte-figura.component.html',
  styleUrls: ['./pediatra-reporte-figura.component.css']
})
export class PediatraReporteFiguraComponent implements OnInit {
  PacienteId!: number;
  paciente: Paciente;
